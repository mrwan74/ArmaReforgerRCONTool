...
if "%~1"=="" (
    ...
    echo Example: pack-all.bat 0.9.0-alpha.4
    echo          pack-all.bat 0.9.0-alpha.4 Debug
    echo.
    exit /b 1
)
...
REM ----------------------------------------------------------------------------
REM [1/5] Publish Windows x64
REM ----------------------------------------------------------------------------
echo.
echo [1/5] Compiling and publishing Windows x64 [%BUILD_CONFIG%, Single-File, ReadyToRun]...
...
REM ----------------------------------------------------------------------------
REM [3/5] Publish Linux x64
REM ----------------------------------------------------------------------------
echo.
echo [3/5] Compiling and publishing Linux x64 [%BUILD_CONFIG%, Single-File, ReadyToRun]...
dotnet publish "%PROJECT_PATH%" ^
    -c %BUILD_CONFIG% ^
    -r linux-x64 ^
    --self-contained true ^
